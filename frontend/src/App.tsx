        ...
        <div className="ui-overlay">
          ...
          <div className="footer-info">
            <nav className="nav-links">
              <button className={`nav-btn ${view === 'generator' ? 'active' : ''}`} onClick={() => setView('generator')}>GENERATOR</button>
              <span className="nav-separator">/</span>
              <button className={`nav-btn ${view.startsWith('archive') ? 'active' : ''}`} onClick={() => setView('archive')}>ARCHIVE</button>
            </nav>
            <div className="footer-right">
              <button className={`nav-btn schrodinger-btn ${view === 'home' ? 'active' : ''}`} onClick={() => setView('home')}>SCHRÖDINGER'S CAT</button>
              {(view === "generator" || view === "archive_about") && (
